...
const Navbar = () => {
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg ${
        isDark
          ? "navbar-dark bg-dark nav-dark"
          : "navbar-light bg-light nav-light"
      } px-3 shadow-sm`}
    >
      <Link className="navbar-brand d-flex align-items-center" to="/">
        <img
      ...
      >
        ...
        <ul className="navbar-nav align-items-end">
          {user?.role === "admin" && (
            <li className="nav-item">
              <Link className="nav-link nav-link-admin" to="/admin/dashboard">
                Admin Dashboard
              </Link>
            </li>
          )}
          ...
          {token ? (
            <>
              <li className="nav-item">
                <LogoutButton className="nav-link nav-link-logout" />
              </li>
              <li className="nav-item">
